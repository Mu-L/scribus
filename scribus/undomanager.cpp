...
void UndoManager::languageChange()
{
	...
	UndoManager::TableRowDelete     = tr("Delete table row");
	UndoManager::TableColumnInsert  = tr("Insert table column");
	UndoManager::TableColumnDelete  = tr("Delete table column");
...
QString UndoManager::TableRowDelete     = "";
QString UndoManager::TableColumnInsert  = "";
QString UndoManager::TableColumnDelete  = "";
